  ...
  return (
    <div className="w-full">
      {[...Array(number)].map((_, idx: number) => (
        <div
          key={idx}
          className="grid gap-5 max-w-full grid-cols-[50px,1fr] p-4"
        >
...
function SkeletonSidebar() {
  ...
  return (
    <div className={"flex px-4 pb-20 pt-4 flex-col gap-4 relative w-[240px]"}>
    ...
    <div className="w-full mt-4">
      ...
      <div className="space-y-4">
        {[...Array(6)].map((_, idx) => (
          <div
            key={idx}
            className="grid grid-cols-2 sm:grid-cols-4 gap-3 px-4 py-2"
          >
            <Skeleton className="h-8 w-full rounded" />
            <Skeleton className="h-8 w-full rounded" />
            <Skeleton className="h-8 w-full rounded" />
